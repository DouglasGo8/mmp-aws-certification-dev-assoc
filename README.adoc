...
* Lambda using Native Image (GraalVM) with Vert.x/Apache Camel and DynamoDb over Terraform and API Gateway only with a GET method
* Lambda using Node.js and Terraform and API Gateway only with a GET method
...
IMPORTANT: Serverkess *does NOT means* "No Servers"
...
* Run your code without thinking about Servers, (but stay locked in AWS =))
