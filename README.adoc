...
aws ecr get-login-password \
  ...
  501317491826.dkr.ecr.sa-east-1.amazonaws.com
docker tag myapp 501317491826.dkr.ecr.sa-east-1.amazonaws.com/aws-dev-repo:myapp

# docker run --rm --name myapp -p 8080:8080 myapp # only local test purpose - must be remove after test
docker push 501317491826.dkr.ecr.sa-east-1.amazonaws.com/aws-dev-repo:myapp
----
