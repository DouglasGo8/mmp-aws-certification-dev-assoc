...
image::content/pic/stepfunction/Payload_staate_input.png[]


After your create your state machine, more doutbs please check :: link giazi :: we can input the the payload and start our processing
