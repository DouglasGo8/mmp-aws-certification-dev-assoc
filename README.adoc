...
* All details can be found over ./terraform/fargate
* Application Load Balance over ASG EC2 (No AMI Custom) in ECR with NGINX Reactjs Container
* All details can be found over ./terraform/asg-nginx-reactjs
...
https://quarkus.io/guides/amazon-lambda-http3
https://aws.amazon.com/pt/blogs/aws-brasil/integracao-do-aws-lambda-com-o-quarkus/

https://www.youtube.com/watch?v=geio38-zAdI

https://how-to.vertx.io/aws-native-image-lambda-howto/