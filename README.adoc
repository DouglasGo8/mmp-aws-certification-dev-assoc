...
. Cross Account Access based on differents Accounts PROD and DEV basend on trusted entities
...
. Auditing - Tunn on AWS Cloudtrail
. Pasword - Configure a strong password policy