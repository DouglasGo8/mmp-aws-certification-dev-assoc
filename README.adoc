...
* Lambda using JVM/Native Image (GraalVM) with Quarkus/Apache Camel, API Gateway and DynamoDb over Terraform IaC,
with only a GET method
****
...
.Sample of Template "`Method Request passthroughs`"
image::content/pic/API_GATEWAY_Mapping_Template_RequestPassthrough.png[]

.Sample of Event details using Method Request passthroughs over Lambda Function
